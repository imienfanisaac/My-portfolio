...
const showChosenQuestion = (question, id) => {
    ...
    document.getElementById("chosen-answer1").value = question.answers.answer1
    document.getElementById("chosen-answer2").value = question.answers.answer2
    document.getElementById("chosen-answer3").value = question.answers.answer3
